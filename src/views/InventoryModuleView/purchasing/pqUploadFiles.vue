  ...
  <div>
   ...
   <div>
    <button
      ...
      v-if="props.itemStatus == 3||props.itemStatus == 4||props.itemStatus == 5"
    >
      {{ $t('Uplaod Files') }}
    ...
    <div class="p-2 mt-3">
      ...
      >
        ...
        <tbody>
          ...
          >
            <td @click="openImageModal(item, image_list[index].name)"> 
      ...
      >
        ...
        <tbody>
          <tr
            ...
            class="image-continer hover-tr flex w-full mx-4 relative"
          >
            <td @click="openImageModal(item.url, item.file_name)"> 
    ...
    <ModalComponent :showModal="isImageOPen" 
      ...
      >
        <div class="">
            ...
            <img :src="itemImage" alt="" class="w-[250px] h-[250px] mx-auto mt-5">
        </div>
      </FormPopUpLayoutComponent>
    </ModalComponent>
  </div>
...
const saveForm = async()=>{
  try{
    ...
    formData.append("operation_type", "rfq");
