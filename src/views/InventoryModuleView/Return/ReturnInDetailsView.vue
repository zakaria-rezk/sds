...
const getRin = async () => {
  loading.value = true;
  try {
    const response = await return_api.getSpecificRinFormItem(
...
//   await return_api.deleteItem(+row_id);
//   getRin();
// };
...
const updateItemDetails = async (
  ...
  await return_api.updateItemDetails(params, +row_id);
  getRin();
};
//FORM
//FORM IMPORTS
...
const submitForm = async () => {
  ...
  try {
    ...
    await return_api.updateItemDetails(payload, detail_id.value);
    getRin();
