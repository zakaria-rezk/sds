...
export default {
  async getReturns(payload: object) {
    try {
      const response = await axios.get(base_url + "inventory/operation-rin");
  ...
  async getSpecificRinFormItem(param: number) {
    try {
      const response = await axios.get(
        base_url + "inventory/operation-rin/" + param
      );
  ...
  async getOutBatches(payload: object) {
    try {
      const response = await axios.get(
        base_url + "inventory/rout/get-out-batches",
        {
          params: payload,
        }
      );
  ...
  async addRetrun(payload: any) {
    try {
      const response = await axios.post(
        base_url + "inventory/operation-rin",
        payload
      );
      return response.data.data;
    } catch (error) {
  ...
  async addItemsToRinForm(payload: any) {
    try {
      await axios.post(base_url + "inventory/operation-rin-details", payload);
    } catch (error) {
      throw error;
    }
  },
  ...
  async updateItemDetails(payload: any, item_id: number) {
    try {
      const response = await axios.put(
        base_url + "inventory/operation-rin-details/" + item_id,
        payload
      );
    } catch (error) {
      throw error;
